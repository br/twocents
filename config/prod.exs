...
# TwocentsWeb.Endpoint.init/2 when load_from_system_env is
...
# start per endpoint:
#
#     config :twocents, TwocentsWeb.Endpoint, server: true
#
...
config :twocents, Twocents.Repo,
 ...
 database: System.get_env("POSTGRES_DBNAME") || "twocents_prod",
